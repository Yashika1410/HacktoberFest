...
### Step#3: [Fork](https://github.com/Yashika1410/HacktoberFest/fork) and clone the repository.
...
### Step#7: Push to your fork `git push` and [submit a pull request](https://github.com/Yashika1410/HacktoberFest/compare).
